...
Similar efforts existed in the community (shoutout to [spark-connect-rs](https://crates.io/crates/spark-connect-rs) which provided plenty of inspiration), but I found existing solutions often felt bloated or were *explicitly marked as experimental*.
